...
const DoaTahajud = ({navigation}) => {
  return (
    <ScrollView style={styles.page} showsVerticalScrollIndicator={false}>
      <Header title="Doa Shalat Tahajud" onPress={() => navigation.goBack()} />
      <Image source={DummyBcTahajud} style={styles.image} />
      ...
      <Image source={DummyDoaTahajud} style={styles.image} />
      <Text style={styles.desc}>
