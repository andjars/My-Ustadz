...
const DoaTaubat = ({navigation}) => {
  return (
    <ScrollView style={styles.page} showsVerticalScrollIndicator={false}>
      <Header title="Doa Shalat Taubat" onPress={() => navigation.goBack()} />
      <Image source={DummyBcTaubat} style={styles.bc} />
      ...
      <Image source={DummyDoaTaubat} style={styles.image} />
      <Text style={styles.desc}>
