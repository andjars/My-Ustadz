...
import {DummyDoaDhuha, DummyBcDhuha} from '../../assets';
import {ScrollView} from 'react-native-gesture-handler';

const DoaShalat = ({navigation}) => {
  return (
    <ScrollView style={styles.page} showsVerticalScrollIndicator={false}>
      <Header title="Doa Shalat Dhuha" onPress={() => navigation.goBack()} />
      <Image source={DummyBcDhuha} style={styles.image} />
      ...
      <Image source={DummyDoaDhuha} style={styles.image} />
      <Text style={styles.desc}>
...
const styles = StyleSheet.create({
  ...
  image: {width: 350, height: 200, paddingLeft: 16, alignItems: 'center'},
});
